...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes(String requestUrl) {
        Log.e(LOG_TAG, "extractEarthquakes called.");

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<Earthquake> earthquakes = new ArrayList<>();
        String earthquakesJsonString = fetchEarthquakeData(requestUrl);
        ...
        try {
            ...
            JSONObject baseJSONResponse = new JSONObject(earthquakesJsonString);
    ...
    private static String fetchEarthquakeData(String requestUrl) {
        ...
        try {
            earthquakesJsonString = makeHttpRequest(url);
        }
        catch (IOException e) {
